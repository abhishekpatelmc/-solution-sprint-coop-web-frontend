        ...
        <div className="ml-10 mr-4 mt-5 flex flex-row">
          ...
          <div className=" basis-3/4 space-y-5 p-5">
            ...
            {interviewClicked
              ? interviews
                  .filter((filtered) => {
                    return jobFieldFilter
                      ? filtered.job_field === jobFieldFilter
                      : filtered &&
                          filtered.job_title
                            .toLowerCase()
                  ...
                  .slice(
                    itemInterviewOffset,
                    itemInterviewOffset + itemsPerPage
                  )
                  .map((interview) => (
                    <div
                      key={interview._id}
                      className="flex flex-col rounded-xl bg-gray-50 bg-gradient-to-t p-6 text-base text-slate-700 shadow-xl shadow-slate-300 transition duration-300 ease-in-out hover:opacity-90"
                    >
                      <p>
                        <Moment
                          format="D MMMM YYYY"
              ...
              : //Second condition to render critiques
                critiques
                  ...
                  .map((critique) => (
                    <div
                      key={critique._id}
                      className="flex flex-col rounded-xl bg-white bg-gradient-to-t p-3 text-base text-slate-600 shadow-xl transition duration-300 ease-in-out hover:opacity-90"
                    >
                      <p>
                        <Moment
                          format="D MMMM YYYY"
                      ...
                      <div>
                        <p className="mt-2 mb-1 text-lg font-semibold">Pros</p>
                        <ol>
                      ...
                      <div>
                        <p className="mt-2 mb-1 text-lg font-semibold">Cons</p>
                        <ol>
            ...
            {interviewClicked ? (
              <PaginationButtons
                handlePageClick={handleInterviewPageClick}
                pageCount={pageInterviewCount}
              />
            ) : (
              <PaginationButtons
                handlePageClick={handleCritiquePageClick}
                pageCount={pageCritiqueCount}
              />
            )}
          </div>
          {/* Right div */}
